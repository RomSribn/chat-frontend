...
describe('UsernameForm Component', () => {
  ...
  it('should display error message when error exists', () => {
    ...
    mockGetErrorMessage.mockReturnValue('The user name must contain at least 3 symbol');
    ...
    expect(screen.getByTestId('alert')).toHaveTextContent('The user name must contain at least 3 symbol');
    expect(screen.getByTestId('alert').getAttribute('data-variant')).toBe('error');
  });
