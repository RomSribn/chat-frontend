...
import { formatMessageTime, getMessageRelativeTime } from '#components/message-list/utils';

// Mock the MessageStatusIndicator component
...
describe('MessageItem Component', () => {
  ...
  it('should render MessageStatusIndicator when status is provided', () => {
    ...
    // Get the calls to MessageStatusIndicator
    const calls = vi.mocked(MessageStatusIndicator).mock.calls;
    expect(calls.length).toBe(1);
    
    // Check the props passed to MessageStatusIndicator
